...
<#
- Test setup
  - Locate and import the module under test (STkrbKeytab.psm1) relative to the test file.
  - Capture module name for InModuleScope usage.
  - Create a temporary output directory in TestDrive: for file-based tests.
...
- Integration tests: Test-Keytab unknown etype
  - Write keytab with a non-mapped etype (e.g., 4095); Test-Keytab -Detailed returns unknown etype list containing 4095.
